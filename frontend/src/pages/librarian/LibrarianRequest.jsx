...
export default function LibrarianRequests() {
  ...
  /* ── Inline styles (Cotton admin theme) ── */
  const S = {
    page: {
      padding: "2rem 3rem",
      maxWidth: "1400px",
  ...
  return (
    <div style={S.page} className="anim-page">
      ...
      <div style={S.header} className="anim-fade-up">
        ...
        <div>
          <h2 style={S.headerTitle}>Pending Book Requests</h2>
          <p style={S.headerSub}>Review and approve student book issue requests</p>
        </div>
      ...
      {loading ? (
        <div style={S.loadingWrap}>
          ...
          <span style={S.loadingText}>Loading requests...</span>
        </div>
      ) : requests.length === 0 ? (
        <div style={S.emptyCard} className="anim-fade-up">
          <div style={S.emptyIcon}>✅</div>
          <h4 style={S.emptyTitle}>All caught up!</h4>
          <p style={S.emptyText}>No pending issue requests at the moment.</p>
        </div>
      ) : (
