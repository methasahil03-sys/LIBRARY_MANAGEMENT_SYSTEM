...
export default function LibrarianLogin() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      showSuccessToast("Welcome, Librarian! 📚");
      navigate("/admin");
    } catch (error) {
  ...
  return (
    <div style={styles.page}>
      <div className="orb orb-blue"   style={{ width: 280, height: 280, top: -60, right: -60 }} />
      <div className="orb orb-purple" style={{ width: 200, height: 200, bottom: 60, left: -40 }} />

      <div style={styles.card} className="anim-scale-in">
        <div style={styles.iconWrap} className="anim-float">
          <span style={{ fontSize: "1.8rem" }}>📚</span>
        </div>

        <h2 style={styles.title}>Librarian Login</h2>
        <p style={styles.sub}>Manage books, issues & member requests</p>

        <form onSubmit={handleSubmit(onSubmit)}>
          <div style={styles.field} className="anim-fade-up anim-delay-1">
          ...
          <div style={styles.field} className="anim-fade-up anim-delay-2">
          ...
          <button
            type="submit"
            disabled={loading}
            className="btn-animated anim-fade-up anim-delay-3"
            style={styles.btn}
          >
            {loading ? (
...
const styles = {
  ...
  card: {
    background: "#ffffff",
    borderRadius: 28, padding: "2.5rem 2.2rem",
    width: "100%", maxWidth: 420,
    boxShadow: "0 20px 60px rgba(100,60,200,0.12)",
  ...
  input: {
    ...
    border: "2px solid #e4ddf5",
    fontFamily: "'Plus Jakarta Sans', sans-serif",
    fontSize: "0.92rem", color: "#2a2050", background: "#fafaff", boxSizing: "border-box",
  },
  eyeBtn: {
